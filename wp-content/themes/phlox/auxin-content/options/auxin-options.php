...
/* ---------------------------------------------------------------------------------------------------
   ...
   --------------------------------------------------------------------------------------------------- */
    ...
    $options[] = array(
        'title'         => __( 'Display Vertical Menu Socials', 'phlox' ),
        'description'   => __( 'Enable it to display social icons at the bottom of vertical menu.', 'phlox' ),
        'id'            => 'site_vertical_menu_socials',
        'id_deprecated' => 'vertical_menu_socials',
        'section'       => 'header-section-main-nav',
        'dependency'    => array(
            array(
                 'id'      => 'site_header_top_layout',
