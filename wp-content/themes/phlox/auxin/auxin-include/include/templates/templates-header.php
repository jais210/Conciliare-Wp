...
function auxin_main_title_preset_args( $defaults, $post = null ){
    ...
    if ( is_archive() ) {
        ...
        $show_titlebar = auxin_get_post_meta( $post, 'aux_title_bar_show', "default" );
    ...
    if( $titlebar_args['show_titlebar'] ){
        ...
        if ( 'default' === $show_titlebar || ( 'yes' === $show_titlebar &&  'default' === auxin_get_post_meta( $post, 'aux_title_bar_preset', 'default' ) ) ) {
                    ...
                    <?php
                        if( auxin_is_true( $add_cart ) ) {
                            auxin_wc_add_to_cart(
                                array(
                                    'css_class'     => 'aux-cart-box aux-desktop-on aux-start aux-middle',
                ...
                <div class="aux-header-elements">
                    ...
                    <?php
                        if( auxin_is_true( $add_cart ) ) {
                            auxin_wc_add_to_cart(
                                array(
                                    'css_class' => 'aux-cart-box aux-desktop-on aux-end aux-middle',
                                    'dropdown_skin' => $dropdown_skin,
                                    'action_on'     => $action_on,
                                    'icon'          => $cart_icon
                                )
...
?>
                ...
                <div class="aux-header-elements">
                    ...
                    <?php
                        if( auxin_is_true( $add_cart ) ) {
                            auxin_wc_add_to_cart(
                                array(
                                    'css_class' => 'aux-cart-box aux-phone-off aux-end aux-middle',
                                    'dropdown_skin' => $dropdown_skin,
                                    'action_on'     => $action_on,
                                    'icon'          => $cart_icon
                                )
        ...
        case 'vertical':
            ...
            $social_display = auxin_get_post_meta( $post, 'page_vertical_menu_socials', 'default' );
            $social_display = 'default' === $social_display ? auxin_get_option('site_vertical_menu_socials', 'yes') :  $social_display ;

            $icon_size = auxin_get_post_meta( $post, 'page_vertical_header_social_icon', 'default' );
            $icon_size = 'default' === $icon_size ? auxin_get_option('site_vertical_header_social_icon', 'small') :  $icon_size ;
...
if( ! function_exists('auxin_the_main_header_section') ){
    ...
    function auxin_the_main_header_section(){
        ...
        $menu_direction = ! empty( $post->ID ) ? auxin_get_post_meta( $post, 'page_header_navigation_layout', 'default') : 'default' ;
        $menu_direction = 'default' === $menu_direction ? auxin_get_option( 'site_header_top_layout', 'horizontal-menu-right' ) : $menu_direction;
        ...
        <header id="site-header" <?php auxin_dom_attributes('site_header'); ?>>
            ...
            <?php if( 'vertical' === $menu_direction ){
