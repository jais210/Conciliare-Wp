...
function auxin_wc_add_to_cart( $args = array() ){
    ...
    ?>
        ...
        <div class="aux-cart-wrapper <?php echo esc_attr( $args['css_class'] ); ?>">
            <div class="aux-shopping-basket aux-action-on-<?php echo esc_attr( $args['action_on'] ); ?>">
...
function auxin_get_post_format_media( $post, $settings = array() ){
    ...
    if( 'single' === $request_from ){
        ...
        if ( 'default' === $post_title_show = auxin_get_post_meta( $post, 'aux_post_title_show', 'default' ) ){
            $post_title_show = auxin_get_option( $post->post_type . '_single_title_show_over_content', 'yes' );
        }
        if( ! auxin_is_true( $post_title_show ) ){
            $args['show_title'] = false;
        }
    ...
    switch ( $the_post_format ) {
        ...
        case 'video':
            ...
            } elseif ( preg_match('#<iframe(.+)</iframe>#i', $url ) ){
                $args['the_attach'] = $url;
        ...
        case 'audio':
            ...
            } elseif( preg_match('#<iframe(.+)</iframe>#i', $_oembed ) ){
