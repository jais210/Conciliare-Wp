/*! Auxin WordPress Framework - v2.0.6 (2018-02-17)
...
/* ------------------------------------------------------------------------------ */
    ...
    $.fn.AuxshpDropdownEffect = function(){
        ...
        $auxCartDropdown    = $auxCartWrapper.find( '.aux-card-dropdown' ),
        auxCartAction       = 'aux-cart-dropdown-hover';

        if ( $auxCartHover.length ) {

            $auxCartHover.mouseover(
                function () {
                    $auxCartDropdown.addClass( auxCartAction );
                }
            );
            $auxCartWrapper.mouseleave(
                function(){
                    $auxCartDropdown.removeClass( auxCartAction );
                }
            );
